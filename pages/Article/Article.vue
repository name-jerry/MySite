		...
		<ShowMD :mdText='mdText' :showMd="showMd" @update='update'
			...
			<template #header>
				<view class="btns">
					...
					<picker v-if='main.artList[0]' class="pickerBtn" mode="selector" :range="main.artList"
						range-key="title" :value='currentArtIndex' @change="currentArtIndex=$event.detail.value">
						{{"文章:"+currentArt.title}}
					</picker>
